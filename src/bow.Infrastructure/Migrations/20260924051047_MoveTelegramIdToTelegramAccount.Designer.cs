...
namespace bow.Infrastructure.Migrations
{
    ...
    [Migration("20260924051047_MoveTelegramIdToTelegramAccount")]
    partial class MoveTelegramIdToTelegramAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bow.Domain.Entities.TelegramAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("TelegramId")
                        .IsUnique()
                        .HasDatabaseName("ix_telegram_accounts_telegram_id");
            ...
            modelBuilder.Entity("bow.Domain.Entities.TelegramAccount", b =>
                {
                    b.HasOne("bow.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("bow.Domain.Entities.TelegramAccount", "UserId")
